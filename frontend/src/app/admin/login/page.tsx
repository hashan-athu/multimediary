...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#F4F5F8]">
      {/* Left Panel - Brand */}
      <div className="hidden md:flex flex-col justify-between w-1/2 bg-admin-sidebar p-12 text-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-admin-purple opacity-10 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl" />
        ...
        <div>
          ...
          <p className="text-admin-sidebar-muted text-lg mb-12">
            ...
            {[
              {
                icon: Film,
                color: "#4299EB",
                text: "Movie & TV series catalogue",
              },
              {
                icon: HardDrive,
                color: "#46BB78",
                text: "Physical disk tracking (DVD, HDD, Blu-ray)",
              },
              {
                icon: Download,
                color: "#9A62FA",
                text: "TMDb metadata auto-import",
              },
        ...
        <div className="text-admin-sidebar-muted text-sm font-medium">
        ...
        <div className="w-full max-w-105 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="bg-white rounded-2xl shadow-sm border border-[#E0E8EF] p-10">
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-[#1C2238] mb-1">
                Welcome back
              </h2>
              <p className="text-[#4F5C72] font-medium">
            ...
            <Form {...form}>
              ...
              >
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="bg-[#EDF1F7] text-black border-none h-11 rounded-lg focus-visible:ring-2 focus-visible:ring-[#4299EB]"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                      ...
                      <div className="relative">
                        <FormControl>
                          <Input
                            ...
                            placeholder="••••••••"
                            className="bg-[#EDF1F7] text-black border-none h-11 rounded-lg focus-visible:ring-2 focus-visible:ring-[#4299EB] pr-10"
                            {...field}
                          />
                        </FormControl>
                        <button
                ...
                <div className="bg-[#4299EB]/10 rounded-lg p-4 flex gap-3 border border-[#4299EB]/20">
                  <AlertCircle
                    size={18}
                    className="text-[#4299EB] shrink-0 mt-0.5"
                  />
                  <p className="text-[12px] leading-relaxed text-[#4299EB] font-medium">
                    One active session is enforced — sign out elsewhere before
                    logging in.
                  </p>
                </div>
